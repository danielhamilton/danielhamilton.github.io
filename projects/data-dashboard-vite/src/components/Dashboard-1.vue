            ...
            <div class="bg-white h-full dark:bg-gray-700">
                <div class="flex items-center justify-start pt-6 ml-8">
                    <p class="font-bold dark:text-white text-xl">
                        Catastrophic Control Center Dashboard
                    </p>
                </div>
                <nav class="mt-6">
                    <div>
                        <a class="w-full text-gray-800 dark:text-white flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start border-l-4 border-indigo-500 bg-indigo-100" href="#">
                            <span class="text-left">
                                <svg width="18" height="18" fill="currentColor" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a class="w-full text-gray-400 flex items-center pl-6 p-2 my-2 transition-colors duration-200 justify-start hover:text-gray-800 border-l-4 border-transparent" href="#">
                            <span class="text-left">
                                <svg width="18" height="18" fill="currentColor" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="mx-2 text-sm font-normal">
                                 Catastrophies
                                <span class="p-1 ml-2 rounded-full w-4 h-4 bg-red-500 text-gray-200 text-xs">
                                 28 
                                </span>
                            </span>
                        </a>
        ...
        <div class="flex flex-col w-full md:space-y-4">
                ...
                <div class="relative z-20 flex flex-col justify-end h-full px-3 md:w-full">
                    <div class="relative p-1 flex items-center w-full space-x-4 justify-end">
                        <button class="flex p-2 items-center rounded-full text-gray-400 hover:text-gray-700 bg-white shadow text-md">
                            <svg width="16" height="16" class="" fill="currentColor" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button class="flex p-2 items-center rounded-full bg-red-500 shadow text-gray-400 hover:text-gray-700 text-md">
                            <svg width="16" height="16" class="text-gray-100" fill="currentColor" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#" class="block relative">
                            <img alt="profil" src="/src/assets/girl-72.jpg" class="mx-auto object-cover rounded-full h-10 w-10 "/>
                        </a>
            ...
            <div class="overflow-auto h-screen pb-24 px-4 md:px-6">
                ...
                <h2 class="text-md text-gray-400">
                    📈 Here&#x27;s what&#x27;s happening with your account today. Lookin' good! 
                </h2>
                        ...
                        <div class="shadow-lg w-full bg-white dark:bg-gray-700 relative overflow-hidden">
                            <a href="#" class="w-full h-full block">
                                ...
                                <div class="w-full h-3 bg-gray-100">
                                    <div class="w-3/5 h-full text-center text-xs text-white bg-green-300">
                                    </div>
                                </div>
                            </a>
                        </div>
                ...
                <div class="flex items-center space-x-4">
                    <button class="flex items-center text-gray-200 text-sm border-gray-300 border px-4 py-2 rounded-full bg-indigo-700">
                        <svg width="16" height="16" fill="currentColor" class="mr-2 text-gray-200" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                        ...
                        Last month
                        <svg width="20" height="20" class="ml-2 text-gray-200" fill="currentColor" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1408 704q0 26-19 45l-448 448q-19 19-45 19t-45-19l-448-448q-19-19-19-45t19-45 45-19h896q26 0 45 19t19 45z">
                            </path>
                        </svg>
                    </button>
                    <span class="text-sm text-gray-400">
                        Compared to October 1 - October 30, 2022
                    </span>
                </div>
